   ...
   class searchAndUpdate extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            for (int i = 0; i < trends.getTrends().length; i++) {
                ...
                //trendd=trends.getTrends()[i].getName();
...
//
    ...
    private class GetJson extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(getApplicationContext(),gethash,Toast.LENGTH_SHORT).show();

           /* if(gethash=="sports")
            {
                sportstring.add(gethash);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(flag==1)
                {
                    Intent intent = new Intent(MainActivity1.this, SplashSports.class);
                    //intent.putExtra(hashh, hash);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_refresh:
                new searchAndUpdate().execute(location);
                Toast.makeText(this, "Refresh selected", Toast.LENGTH_SHORT)
                        .show();
                break;
            // action with ID action_settings was selected
            case R.id.action_settings:
                Toast.makeText(this, "Settings to show(If Any)", Toast.LENGTH_SHORT)
                        .show();
                break;
